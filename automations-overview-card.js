/* Automations Overview Card - V42 - refined next-planned layouts and recursive action details (issue #9); based on V41 */
...
class AutomationsOverviewCard extends HTMLElement {
  ...
  _compactSettingsPanelHtml() {
    if (this._displayMode === "full" || !this.config.show_compact_settings || !this._legendFiltersOpen) return "";
